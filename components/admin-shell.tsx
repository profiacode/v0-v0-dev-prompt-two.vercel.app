      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-2">
            ...
            <div className="ml-4 bg-primary/10 text-primary text-xs px-2 py-1 rounded-md">Área Administrativa</div>
          </div>
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                  <Avatar className="h-8 w-8">
                    <AvatarImage src="/images/lawyer1.png" alt="Avatar" />
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                <DropdownMenuLabel className="font-normal">
                  <div className="flex flex-col space-y-1">
                    ...
                    <p className="text-xs leading-none text-muted-foreground">carlos.mendes@jurisconsult.com</p>
                  </div>
                </DropdownMenuLabel>
                <DropdownMenuSeparator />
